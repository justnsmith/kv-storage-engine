...
void benchmarkBloomFilterMemoryEfficiency() {
    ...
    std::cout << std::setw(15) << "Elements"
              << std::setw(15) << "FP Rate"
              << std::setw(15) << "Size (KB)"
              << std::setw(15) << "Bits/Element" << "\n";
    ...
    for (size_t num_elements : sizes) {
        for (double fp_rate : fp_rates) {
            ...
            std::cout << std::setw(15) << num_elements
                      << std::setw(15) << std::fixed << std::setprecision(3) << (fp_rate * 100) << "%"
                      << std::setw(15) << std::setprecision(2) << (bf.size() / 1024.0)
                      << std::setw(15) << std::setprecision(1) << (bf.size() * 8.0 / num_elements)
                      << "\n";
        }
    }
    std::cout << "\n";
