...
bench: benchmarks
	...
	@echo ""
	@./$(BUILD_DIR)/benchmark_multithreaded
...
bench-mt: $(BUILD_DIR)/benchmark_multithreaded
	./$(BUILD_DIR)/benchmark_multithreaded
...
.PHONY: all run test benchmarks bench bench-write bench-read bench-bloom bench-compaction bench-mt clean check
