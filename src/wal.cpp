...
uint32_t WriteAheadLog::calculateChecksum(Operation op, const std::string &key, const std::string &value) {
...
void WriteAheadLog::append(Operation op, const std::string &key, const std::string &value) {
...
void WriteAheadLog::replay(std::function<void(Operation, std::string &, std::string &)> apply) {
